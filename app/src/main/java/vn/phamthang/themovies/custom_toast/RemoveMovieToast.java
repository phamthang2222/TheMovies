...
import vn.phamthang.themovies.databinding.LayoutRemoveFavToastBinding;

public class RemoveMovieToast {
    private static LayoutRemoveFavToastBinding binding;
    private static Toast toast;
    public RemoveMovieToast(Context mContext, String content) {
        binding = LayoutRemoveFavToastBinding.inflate(LayoutInflater.from(mContext));
